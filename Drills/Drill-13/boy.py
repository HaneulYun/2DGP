...
class WalkingState:
    ...
    def do(boy):
        ...
        boy.x = clamp(PIXEL_PER_METER * 6.5 * (boy.y / boy.bg.h), boy.x,
                      boy.bg.w - PIXEL_PER_METER * 6.5 * (boy.y / boy.bg.h))
        boy.y = clamp(0 + PIXEL_PER_METER * 2.2, boy.y,
                      boy.bg.h - PIXEL_PER_METER * 1)
